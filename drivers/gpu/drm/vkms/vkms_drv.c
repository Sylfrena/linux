...
MODULE_PARM_DESC(enable_virtual_hw, "Enable/Disable virtual hardware mode
				(virtual hardware mode disables vblank interrupts)");
...
static int vkms_create(struct vkms_config *config)
{
	...
	if (vkms_device->config->virtual_hw == 1)
